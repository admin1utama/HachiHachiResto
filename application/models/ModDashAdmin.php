...
class modDashAdmin extends CI_Model {
    ...
    public function select_stok($idcabang){
		...
		return $this->db->query("select stokcabang.*, bahan.namabahan, bahan.jenis, bahan.satuan from stokcabang, bahan where stokcabang.kodebahan=bahan.kodebahan and bahan.jenis='BAHAN BAKU' and stokcabang.kodecabang ='$idcabang' and stokcabang.stok < 10 order by stok ASC"); 
    }
