...
class modPermintaanBahanOutlet extends CI_Model {
    ...
    {
        return $this->db->query("select hpermintaan.*, cabang.namacabang,kota from hpermintaan, cabang where hpermintaan.kodecabang = cabang.kodecabang and hpermintaan.status = 'AKTIF'");
    }
