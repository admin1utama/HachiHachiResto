  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Input Kepala Gudang</b></h3>
          </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                            if($kodekaryawan == "" ){
                                echo form_submit("btnAdd_KG", "Tambah Kepala Gudang", ['id'=>'btnAdd_KG', 'class'=>'btn btn-primary btn-lg']);
                            }
                            else{
