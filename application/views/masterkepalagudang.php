  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa fa-bars"></i>Input Kepala Gudang</h3>
          </div>
        </div>

        <!-- page start-->      
        <?php 
        echo form_open("KepalaGudang/masteroperator"); 
        ?>        
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <br>
                                <?php 
                                    echo "<a href='".site_url('KepalaGudang/index')."'>"; 
                        ...
                        <div class="row">
                            <div class=col-md-4>
                                <label>Jabatan : </label>
                                <?php 
                                    echo form_input("txtjabatankaryawan", "KEPALA GUDANG", ['id'=>'txtjabatankaryawan', 'type'=>'text', 'class'=>'form-control', 'readonly'=>'readonly']);
                                ?> 
                            </div>
                            <div class=col-md-4>
                        ...
                        <?php
                            if($kodekaryawan == "" ){
                                echo form_submit("btnAdd_KG", "Tambah Kepala Gudang", ['id'=>'btnAdd_KG', 'class'=>'btn btn-success']);
                            }
                            else{
                                echo form_submit("btnUpdate_KG", "Update Kepala Gudang", ['id'=>'btnUpdate_KG', 'class'=>'btn btn-warning']);  
                                echo form_submit("btnRemove_KG", "Hapus Kepala Gudang", ['id'=>'btnRemove_KG  ', 'class'=>'btn btn-danger']);
