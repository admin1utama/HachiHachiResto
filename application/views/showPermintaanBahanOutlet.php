  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa fa-bars"></i>Penerimaan Permintaan Bahan Outlet</h3>
          </div>
        </div>
                            ...
                            <div class="col-md-12">
                                <?php 
                                  echo "<a href='".site_url('PermintaanBahanOutlet/tambahPermintaan')."'>"; 
                                      echo form_button("btntambah", "Tambah Permintaan", ["class"=>"btn btn-danger"]);
                                  echo "</a>"; 
                                ?>
                                <br><br><br>
                                <div class="card-body">
                                    <table class='table table-striped'>
                                        ...
                                        foreach($datapemesananbahan->result() as $row) {
                                            ...
                                            echo "<tr>"; 
                                                ...
                                                "</b></h3><br>Nama Cabang : ".$row->namacabang.
                                                "<br>Kota : ".$row->kota."</th>";
