...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Laporan Kartu Stok</b></h3>
          </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php 
                            ...
                            echo form_button("btnPrint", "Cetak", ['id'=>'btnPrint', 'class'=>'btn btn-success btn-lg']);  
                            echo "</a>";   
                        ?>
                        <br><br>
                        <div class="row">
  ...
  function printlaporan() {
    ...
    window.open(myurl + "/Bahan/cetak/" + kodebahan + "/" + kodecabangg, "_blank"); 
  }
