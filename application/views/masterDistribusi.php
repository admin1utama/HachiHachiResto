  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Transaksi Distribusi</b></h3>
          </div>
        </div>
                    ...
                    <?php
                      ...
                      for($i = 0; $i < $jum; $i+=1){
                          echo "<tr>";
                            ...
                            echo "<td><input value='1' type='number' name='txtqtyasal".$i."' id='txtqtyasal".$i."' class='form-control'></td>"; 
