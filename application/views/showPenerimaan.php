  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"  style="color:black"><b><i class="fa fa fa-bars"></i>Penerimaan Pemesanan Bahan Makanan</b></h3>
          </div>
        </div>
                                    ...
                                    <table class='table table-striped'>
                                        ...
                                        foreach($datapemesananbahan->result() as $row) {
                                            ...
                                            echo "<tr>"; 
                                              ...
                                              echo "<th><h3 style='font-weight: bold;'>Rp. ".number_format($row->subtotal).",-</h3><th>";
