  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa fa-bars"></i> Bahan Jadi</h3>
          </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php 
                                echo "<a href='".site_url('Bahanjadi/kategoribahanjadi')."'>"; 
                                ...
                                <div class="card-body">
                                    <table class='table table-striped'>
                                        ...
                                        foreach($databahanjadi->result() as $row) {
                                            echo "<tr>"; 
                                                echo "<td>".$row->kodekategoribahanjadi."</td>"; 
                                                echo "<td>".$row->namakategoribahanjadi."</td>";
