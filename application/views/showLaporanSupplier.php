...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Laporan Supplier</b></h3>
          </div>
        </div>
        <!-- page start-->
        <?php 
        echo form_open("LaporanSupplier/cetak"); 
        ?>          
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                        ...
                        <div class="row">
                          <div class="col-md-10">      
                                <div class="card-body">
                                    ...
                                    <thead>
                                        <tr>
                                        <th class="tengahtulisan">Kode Supplier</th>
                                        <th class="tengahtulisan">Nama Supplier</th>
                                        <th class="tengahtulisan">Kontak Person</th>
  ...
  function lihat()
  {
    ...
    //alert(datanama);
    $.post(myurl + "/LaporanSupplier/getFilter",
      { datanama:datanama },
      function(res){
        //alert(res);
        $("#divKanan").html(res);
