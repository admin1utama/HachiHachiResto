...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Bill Of Material</b></h3>
          </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class=col-md-4>
                                ...
                                <?php 
                                  echo "<input type='number' name='txtQty' id='txtQty' class='form-control'>"; 
                                    // echo form_input("txtQty", "", ['id'=>'txtQty', 'type'=>'number', 'class'=>'form-control']);
                                    //kalau pakai spinner yang bawah 94 ini di buka remarknya
  ...
  function insertBom()
  {
    ...
    //alert(qty);
    if(qty=="")
    { alert("Nilai Qty Harus Diisikan"); }
    else
    {
