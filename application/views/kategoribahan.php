                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class=col-md-4>
                                ...
                                <?php 
                                    echo form_input("txtsatuanbahan", $satuan, ['id'=>'txtsatuanbahan', 'type'=>'text', 'class'=>'form-control']);
                                ?>
                            </div>
                            <div class=col-md-4>
                                <label>Jenis :</label><br>
                                <?php 
                                    echo form_input("txtjenisbahan", $jenis, ['id'=>'txtjenisbahan', 'type'=>'text', 'class'=>'form-control']);
                                ?>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class=col-md-4>
                                ...
                                <?php 
                                    echo form_input("txtstatusbahan", $status, ['id'=>'txtstatusbahan', 'type'=>'text', 'class'=>'form-control']);
                                ?>  
                            </div>
                        </div>
                        <br><br>
