...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Laporan Member</b></h3>
          </div>
        </div>
        <!-- page start-->
        <?php 
        echo form_open("LaporanMember/cetak"); 
        ?>          
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                              ...
                              <div class="row">
                                <div class="col-md-10"> 
                                  <div class="card-body">
                                    ...
                                    <thead>
                                        <tr>
                                        <th class="tengahtulisan">Kode Member</th>
                                        <th class="tengahtulisan">Nama Member</th>
                                        <th class="tengahtulisan">Email</th>
                                        <th class="tengahtulisan">Kota</th>
                                        <th class="tengahtulisan">Alamat</th>
                                        <th class="tengahtulisan">Tanggal Lahir</th>
  ...
  function lihat()
  {
    ...
    //alert(datanama);
    $.post(myurl + "/LaporanMember/getFilter",
      { datanama:datanama },
      function(res){
        //alert(res);
        $("#divKanan").html(res);
