                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                echo "<a href='".site_url('Bahan/BOM')."'>"; 
                                    echo form_button("btnBOM", "Bill Of Material", ["class"=>"btn btn-lg btn-danger"]);
                                echo "</a>"; 
                                ?>
                                <?php
                                echo "<a href='".site_url('Bahan/kartustok')."'>"; 
                                    echo form_button("btnKRT", "Kartu Stok", ["class"=>"btn btn-lg btn-danger"]);
                                echo "</a>"; 
                                ?>
                                <br><br><br>
                                <div class="card-body">
