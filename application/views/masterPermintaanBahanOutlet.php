...
<?php
  ...
  {
    if($row->kodecabang == $this->session->userdata('codecabang')) {
...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Transaksi Permintaan Bahan Cabang</b></h3>
          </div>
        </div>
        ...
        <div class="row">
            ...
            <table class="table table-splitted">
              <thead>
                ...
                <tr>
                  ...
                  <td>
                  <input type='date' name='txtdate' readonly='readonly' id='txtdate' class='form-control' value='<?php echo date("Y-m-d"); ?>'>                         
                      <?php 
          ...
          <div class="col-md-6">
            <label class='judullabel'>Cabang : </label>
            <?php 
              ...
              <div class="row">
                <div class=col-md-6>
                  ...
                  <label class='judullabel'>Qty :</label><br>
                    <?php 
                      echo "<input type='number' min='1' value='1' name='txtQtyPemesanan' id='txtQtyPemesanan' class='form-control'>"; 
                        // echo form_input("txtQtyPemesanan", "", ['id'=>'txtQtyPemesanan', 'type'=>'number', 'class'=>'form-control']);
                    ?>
                  <!-- batas-->                 
                </div>
                <div class=col-md-6>
                    ...
                    <?php
                      ...
                      for($i = 0; $i < $jum; $i+=1){
                          echo "<tr>";
                            ...
                            echo "<td><button onclick=hapuspermintaanbahan($i) type='button' class='btn btn-lg btn-danger'><i class='icon_trash_alt'></i></button></td>"; 
                          echo "</tr>";
                      }
                      echo "</table>";
                      }
  ...
  {
    //alert("masuk sini");
    var kodecabang = $("#txtcabang").val(); 
    var idbahan    = $("#dropBahanBaku").val();
    $.post(myurl + "/PermintaanBahanOutlet/getStok",
  ...
  function hapuspermintaanbahan(no) 
  {
    $.post(myurl + "/PemesananBahan/removeFromCart",
      { no: no },
      function(res){
        //alert(res); 
        window.location = myurl + "/PermintaanBahanOutlet/tambahPermintaan"; 
      }
    );
  }
