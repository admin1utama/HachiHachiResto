  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Supplier</b></h3>
          </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                ?>
                                <?php 
                                echo "<a href='".site_url('Supplier/pricelist')."'>"; 
                                    echo form_button("btnpricelist", "Harga Bahan", ["class"=>"btn btn-danger btn-lg"]);
                                echo "</a>"; 
                                ?>
                                <br><br><br>
                                <div class="card-body">
