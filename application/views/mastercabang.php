  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Input Cabang</b></h3>
          </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class=col-md-4>
                                ...
                                <?php 
                                    echo form_input("txtkodecabang", $kodecabang, ['id'=>'txtkodecabang', 'type'=>'text', 'class'=>'form-control','readonly'=>'readonly']);
                                ?>
                            </div>
                            <div class=col-md-6>
                                <br><br>
