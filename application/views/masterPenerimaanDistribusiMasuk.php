  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Transaksi Penerimaan Distribusi Masuk</b></h3>
          </div>
        </div>

        <!-- page start-->      
        <?php 
        echo form_open("DistribusiMasuk/penerimaan"); 
        ?>
        <div class="row">                            
          <div class="col-md-6">                                
            <br>
            <?php 
              echo "<a href='".site_url('DistribusiMasuk/index')."'>"; 
        ...
        <div class="row">
          <div class="col-md-6">
            <table class="table table-splitted">
              <thead>
                <tr>
                  <th><h5 class='judullabel'>Nomer Nota Penerimaan Distribusi Masuk: </th></h5>             
                  <td>                      
                      <?php 
                ...
                <tr>
                  <th><h5 class='judullabel'>Nomer Nota Distribusi Masuk: </th></h5>             
                  <td>                      
                      <?php 
                        echo form_input("txtNoNotaDisKeluar", $nomernota, ['id'=>'txtNoNotaDisMasuk', 'type'=>'text', 'class'=>'form-control', 'readonly'=>'readonly']);
                      ?>
                  </td>
                </tr>
                <tr>
    ...
    <!--bekas hapus disini -->
            ...
            <?php 
                echo form_submit("btnSimpan", "Lakukan Penerimaan", ['id'=>'btnSimpan', 'class'=>'btn btn-lg btn-primary','onchange'=>'generatenota()']);
            ?>
        </div>
        </div> 
        <?php 
