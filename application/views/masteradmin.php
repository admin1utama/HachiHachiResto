  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Input Admin</b></h3>
          </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class=col-md-4>
                                ...
                                <?php 
                                    ...
                                    echo form_dropdown("txtkodecabang", $arrcabang, $kodecabang, ['id'=>'txtkodecabang', 'type'=>'text', 'class'=>'form-control', 'style'=>'display:none']);
                                ?>
                            </div>
                            <div class=col-md-6>
                                <br><br>
                        ...
                        <div class="row">
                            <div class=col-md-4>
                                <label class="judullabel">Confrim Password : </label>
                                <?php 
                        ...
                        <?php
                            if($kodekaryawan == "" ){
                                echo form_submit("btnAdd_Admin", "Tambah Admin", ['id'=>'btnAdd_Admin', 'class'=>'btn btn-lg btn-primary']);
                            } 
                            else{
