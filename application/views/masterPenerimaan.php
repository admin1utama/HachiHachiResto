  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Transaksi Penerimaan Bahan Makanan</b></h3>
          </div>
        </div>
    ...
    <!--bekas hapus disini -->
                    ...
                    <?php
                     // if($this->session->userdata("cartdetail")){
                      ...
                      echo "<tr>";
                        ...
                        echo "<th style='text-align: center;'>Konversi </th>";
                      ...
                      for($i = 0; $i < $jum; $i+=1){
                          echo "<tr>";
                            ...
                            echo "<td style='text-align: center;'>".$arr[$i][6]."</td>";
            ...
            <?php 
                echo form_submit("btnSimpan", "Simpan Penerimaan", ['id'=>'btnSimpan', 'class'=>'btn btn-lg btn-primary','onchange'=>'generatenota()']);
            ?>
        </div>
        </div> 
        <?php 
