      ...
      <section class="wrapper">
        ...
        <div class="row">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <div class="custom-control custom-radio">
                    <input type="radio" id="satu" name="Status" value="AKTIF" class="custom-control-input">
                    <label class="custom-control-label" for="customRadio1">AKTIF</label>
                  </div>
                  </td>
                  <td>
                  <div class="custom-control custom-radio">
                    <input type="radio" id="dua" name="Status" value="NONAKTIF" class="custom-control-input">
          ...
          <div class="col-md-6">
            ...
            <?php 
              echo form_dropdown("txtSupplier", $arrsupp, $supplier , ['id'=>'txtSupplier', 'type'=>'text', 'class'=>'form-control','onchange'=>'lihatsupplier(),lihatbahan()', 'readonly'=>'readonly']);
            ?>
            <table class="table table-splitted">
              <tbody id="divKanan">
              </tbody>
