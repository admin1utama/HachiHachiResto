                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class=col-md-12>
                                ...
                                <?php 
                                    echo form_input("txtstatus", "", ['id'=>'txtstatus', 'type'=>'text', 'class'=>'form-control']);
                                ?>
                            </div>
                        </div>
                        <br><br>
                ...
                <table class='table table-striped'>
                    ...
                    foreach($datapaketmenu->result() as $row) {
                        ...
                        echo "<tr>"; 
                            ...
                            echo "<td><a href='".site_url('PaketMenu/detailmenu/'.$row->kodepaket)."'><button type='button' class='btn btn-danger'><i class='icon_pencil-edit_alt'></i></button></td>";
                            echo "<td><a href='".site_url('PaketMenu/detailmenu/'.$row->kodepaket)."'><button type='button' class='btn btn-danger'><i class='icon_close_alt2 '></i></button></td>";
                        echo "</tr>"; 
                        echo form_close();
                    }
