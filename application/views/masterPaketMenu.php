  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Paket Menu</b></h3>
          </div>
        </div>
        <!-- page start-->      
        <?php 
                        ...
                        <div class="row">
                            <div class=col-md-4>
                                <div class="form-group">
                                    ...
                                    <?php 
                                        echo form_input("txtkodepaket", "", ['id'=>'txtkodepaket', 'type'=>'text', 'class'=>'form-control','readonly'=>'readonly']);
                                    ?>
                        ...
                        <div class="row">
                            <div class=col-md-4>
                                ...
                                <?php
                                    ...
                                    echo form_dropdown("txtstatus",$options, "", ['id'=>'txtstatus', 'type'=>'text', 'class'=>'form-control','readonly'=>'readonly']);
                                ?>
                            </div>
                        </div>
                        <br><br>
                ...
                <table class='table table-striped'>
                    ...
                    foreach($datapaketmenu->result() as $row) {
                        ...
                        echo "<tr>"; 
                            ...
                            if($row->status == "AKTIF") {
                                echo "&nbsp;&nbsp; <a href='".site_url('Paketmenu/blockmenu/'.$row->kodepaket)."'><button type='button' class='btn btn-danger'><i class='icon_close_alt2 '></i></button></td>";
                            }
                            else {
                                echo "&nbsp;&nbsp; <a href='".site_url('Paketmenu/unblockmenu/'.$row->kodepaket)."'><button type='button' class='btn btn-success'><i class='icon_clock_alt'></i></button></td>";
                            }
                        echo "</tr>"; 
                        echo form_close();
                    }
