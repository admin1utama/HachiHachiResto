...
<div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        <?php echo "<center><img src='".base_url('asset/img/logohachi.png')."' style='width:150px'><b>HACHI-HACHI BISTRO</b></center>";  ?>
      </div>
    </div>
    <?php 
    ...
    ?>
        <div class="login-wrap">
          <h3 style="text-align: center; style="color:black"><b>Login</b></h3>
          <?php 
            if(isset($message)) {
              echo "<h5 style='font-weight: bold; text-align: center; color: red;'>$message</h5>";
            }
