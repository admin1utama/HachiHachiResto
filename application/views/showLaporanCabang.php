...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Laporan Cabang</b></h3>
          </div>
        </div>
        <!-- page start-->
        <?php 
        echo form_open("LaporanCabang/cetak"); 
        ?>          
        <div class="row">
            <div class="col-md-12">
                <div class="card">
  ...
  function lihat()
  {
    ...
    //alert(datanama);
    $.post(myurl + "/LaporanCabang/getFilter",
      { datanama:datanama },
      function(res){
        //alert(res);
        $("#divKanan").html(res);
