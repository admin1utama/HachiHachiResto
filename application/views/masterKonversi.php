  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa fa-bars"></i>Insert Konversi</h3>
          </div>
        </div>
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class=col-md-12>
                            <label>Konversi Pertama :</label><br>
                                <?php 
                        ...
                        <br><br>
                       <?php 
                            echo form_button("btnSimpanKonversi", "Simpan", ['id'=>'btnSimpanKonversi', 'class'=>'btn btn-success', 'onclick'=>'insertKonversi()']);
                        ?>
                    </div>
                </div> 
            </div>
