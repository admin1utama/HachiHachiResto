  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa fa-bars"></i>Distribusi Keluar</h3>
          </div>
        </div>
                                ...
                                <div class="card-body">
                                    <table class='table table-striped'>
                                        ...
                                        foreach($datadistribusi->result() as $row) {
                                            ...
                                            echo "<tr>"; 
                                                echo "<th><b><h3 style='color:red';>Nomer Nota : <br>".$row->nomernota.
                                                "</b></h3><br><b><h4 style='color:black';>Cabang Asal : ".$row->namacabangasal.
                                                "<br>Kota : ".$row->kotaasal."</b></th>";
                                                
                                                echo "<th><b><h3 style='color:black';><br><br></h3><br><b><h4 style='color:black';>Cabang Asal : ".$row->namacabangtujuan.
                                                "<br>Kota : ".$row->kotatujuan."</b></th>";
