  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa fa-bars"></i>Distribusi</h3>
          </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php 
                                  echo "<a href='".site_url('Distribusi/tambahdistribusi')."'>"; 
                                      echo form_button("btntambah", "Tambah Distribusi", ["class"=>"btn btn-danger"]);
                                  echo "</a>"; 
                                ?>
                                <br><br><br>
                                <div class="card-body">
                                    <table class='table table-striped'>
                                        ...
                                        foreach($datadistribusi->result() as $row) {
                                            ...
                                            echo "<tr>"; 
                                                ...
                                                "</b></h3><br>Cabang Asal : ".$row->namacabangasal." &nbsp&nbsp&nbsp Cabang Tujuan :".$row->namacabangtujuan.
                                                "<br>Kota : ".$row->kotaasal." &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Kota : ".$row->kotatujuan."</th>";
