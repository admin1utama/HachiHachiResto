  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:black"><b><i class="fa fa fa-bars"></i>Laporan Bahan</b></h3>
          </div>
        </div>
        <!-- page start-->
        <?php 
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    <?php
                                        ...
                                        echo "<br>";
                                        echo form_button("btnLihat", "Lihat", ['id'=>'btnLihat', 'class'=>'btn btn-lg btn-success','onclick'=>'lihatbahan()']);  
