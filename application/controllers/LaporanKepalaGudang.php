...
class LaporanKepalaGudang extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('modLaporanKepalaGudang');
		$this->load->library('session'); 
	}
	public function index()
	{
		$this->load->view('showLaporanKepalaGudang');
    }
    ...
    public function getFilter()
	{
        ...
        //echo $datafilter;
		$datakaryawan 	= $this->modLaporanKepalaGudang->selectfilter($datafilter);
	...
	public function cetak()
	{
		if($this->input->post('btnPrint')) {
			...
			//echo $datafilter;
			$data['cetakdata']	= $this->modLaporanKepalaGudang->selectfilter($datafilter);
			//echo count($bhnbaku->result());

			$this->load->view('showCetakLaporanKepalaGudang',$data);
		}
	}
}
