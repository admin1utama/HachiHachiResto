	...
	{        
        if($this->input->post('btnAddPaket')) {
			...
			/*$this->form_validation->set_rules(
				'txtkodepaket', 'Kode Paket',
                'required',
                array('required'     =>'Kolom Kode Paket Tidak Boleh Kosong'));*/
            $this->form_validation->set_rules(
				'txtnamapaket', 'Nama Paket',
                'required',
				array('required'     =>'Kolom Nama Paket Tidak Boleh Kosong'));
			$this->form_validation->set_rules(
				'txthargapaket', 'Harga Paket',
				'required|numeric',
				array('required'     =>'Kolom Harga Paket Tidak Boleh Kosong',
						'numeric'     =>'Kolom Harga Paket hanya berisi angka'));
