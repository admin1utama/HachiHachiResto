...
class Distribusi extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['datadistribusi'] = $this->modDistribusi->select_data();
		$this->load->view('showDistribusi',$data);
    }
	...
	public function tambahdistribusi()
    {
		...
		if($this->input->post('btnSimpan')){
			...
			$nomernota = $this->modDistribusi->insert_hdistribusi($asal,$tujuan,$tanggal);
			...
			for($i = 0; $i < $jumcart; $i+=1){
				...
				//echo $kodebahan."-";
				//echo $qty."=";
				$this->modDistribusi->insert_ddistribusi($nomernota,$kodebahan,$kodesatuan,$qtypengiriman);
			}
		...
		else if($this->input->post ("btnTambah"))
		{
			...
			if($this->session->userdata("cart"))
			{
				...
				$databahan = $this->modDistribusi->getDataNamaBahan($txtkodebahanbaku);
    ...
    public function getDetailCabang()
    {
        ...
        $dtcabang = $this->modDistribusi->selectdetailcabang($idcabang);
        //echo $idsupplier;
		$nomer =1;
	...
	public function getBahan()
	{
		...
		//echo $idsupplier;
		$dtsupplier = $this->modDistribusi->selectnomernota($idsupplier);
	...
	public function getStok()
	{
		...
		$bhnbaku = $this->modDistribusi->selectstok($idbahan);
