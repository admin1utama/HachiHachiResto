...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2021 at 03:54 AM
...
(18, 'DDIS2021001', 3, 'KG', 1, 0),
(19, 'DDIS2021001', 32, 'PCS', 1, 0),
(20, 'DDIS2021001', 33, 'PCS', 1, 0),
(21, 'DDIS2021002', 3, 'KG', 1, 1),
(22, 'DDIS2021002', 33, 'PCS', 1, 1),
(23, 'DDIS2021002', 32, 'PCS', 1, 1);
...
(50, 'JLY2021001', 29, 'PCS', 1, 27500),
(51, 'JLY2021002', 16, 'KG', 10, 90000),
(52, 'JLY2021003', 16, 'KG', 20, 90000),
(53, 'JLY2021004', 16, 'KG', 5, 90000);
...
(11, 'TR2021001', 16, 'KG', 10, 10, 90000),
(12, 'TR2021002', 16, 'KG', 10, 10, 90000),
(13, 'TR2021003', 29, 'PCS', 1, 1, 27500),
(14, 'TR2021004', 16, 'KG', 20, 20, 90000),
(15, 'TR2021005', 16, 'KG', 20, 20, 90000),
(16, 'TR2021006', 16, 'KG', 20, 20, 90000),
(17, 'TR2021007', 16, 'KG', 5, 5, 90000);
...
('DDIS2021001', '2021-01-19', 'KC1', 'KC1', 'AKTIF'),
('DDIS2021002', '2021-01-19', 'KC1', 'KC3', 'TERKIRIM');
...
('JLY2021001', '2021-01-19', 'SP1', 0, 'DITERIMA'),
('JLY2021002', '2021-01-19', 'SP1', 0, 'DITERIMA'),
('JLY2021003', '2021-01-19', 'SP1', 0, 'DITERIMA'),
('JLY2021004', '2021-01-19', 'SP1', 0, 'DITERIMA');
...
('TR2021001', 'JLY2021002', '2021-01-19', 'SP1', 'AKTIF'),
('TR2021002', 'JLY2021002', '2021-01-19', 'SP1', 'AKTIF'),
('TR2021003', 'JLY2021001', '2021-01-19', 'SP1', 'AKTIF'),
('TR2021004', 'JLY2021003', '2021-01-19', 'SP1', 'AKTIF'),
('TR2021005', 'JLY2021003', '2021-01-19', 'SP1', 'AKTIF'),
('TR2021006', 'JLY2021003', '2021-01-19', 'SP1', 'AKTIF'),
('TR2021007', 'JLY2021004', '2021-01-19', 'SP1', 'AKTIF');
...
--
ALTER TABLE `ddistribusi`
  MODIFY `notadetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `dpembelian`
  MODIFY `notadetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
