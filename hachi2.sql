...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2020 at 03:15 PM
...
(16, 'LEMON', 'KG', 'BAHAN BAKU', 90000, 3, '', 'AKTIF'),
(17, 'KIKOMAN', 'PC', 'BAHAN BAKU', 30000, 3, '', 'AKTIF');
...
('OP2', 'KC2', 'Heni', '12345', 'HENI LUTFI', '2010-04-01', '357707066687008', '081553763775', 'OPERATOR', 'NONAKTIF'),
...
--
ALTER TABLE `bahan`
  MODIFY `kodebahan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
