...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2020 at 11:46 PM
...
(5, 'BAKSO CUMI', 'PC', 'BAHAN BAKU', 25000, 2, 'default.jpg', 'AKTIF'),
(6, 'FRENCH FRIES', 'PACK', 'BAHAN BAKU', 37000, 2, 'default.jpg', 'AKTIF'),
(7, 'BERAS LOKAL', 'SAK', 'BAHAN BAKU', 45000, 6, 'default.jpg', 'AKTIF'),
...
('DJ01', 'KC2', 'djaja', '123456', 'DJAJA A', '2010-06-01', '357808098287004', '081553763773', 'KEPALA GUDANG', 'AKTIF'),
...
--
ALTER TABLE `bahan`
  MODIFY `kodebahan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
